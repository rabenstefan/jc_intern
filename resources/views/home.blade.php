                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                                <div class="panel-element panel-element-warning">
                                    ...
                                    <a href="#" title="{{ trans('home.generate_semester') }}" class="btn btn-2d btn-post" data-url="{{ route('semesters.generateNew') }}">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                            ...
                            <div class="panel-element panel-element-info">
                                ...
                                <a href="{{ route('dates.index', ['view_type' => 'list', 'hideByType' => ['birthday'], 'hideByStatus' => \App\Http\Controllers\DateController::invertDateStatuses(['unanswered', 'maybe-going'])]) }}">{{ trans('home.all_unanswered_maybe') }}</a>
                                <a href="{{ route('dates.index', ['view_type' => 'list', 'hideByType' => ['birthday'], 'hideByStatus' => \App\Http\Controllers\DateController::invertDateStatuses(['unanswered'])]) }}">{{ trans('home.all_unanswered') }}</a>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                            ...
                            <div class="panel-element panel-element-info">
                                ...
                                <a href="{{ route('dates.index', ['view_type' => 'list', 'hideByType' => \App\Http\Controllers\DateController::invertDateTypes(['rehearsal'])]) }}">{{ trans('home.all_rehearsals') }}</a>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                            ...
                            <div class="panel-element panel-element-info">
                                ...
                                <a href="{{ route('dates.index', ['view_type' => 'list', 'hideByType' => \App\Http\Controllers\DateController::invertDateTypes(['gig'])]) }}">{{ trans('home.all_gigs') }}</a>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                            ...
                            <div class="panel-element panel-element-info">{{ trans('home.upcoming_birthdays', ['count' => $upcoming_birthdays->count()])}}
                                <a href="{{ route('dates.index', ['view_type' => 'list', 'hideByType' => \App\Http\Controllers\DateController::invertDateTypes(['birthday'])]) }}">{{ trans('home.all_birthdays') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
